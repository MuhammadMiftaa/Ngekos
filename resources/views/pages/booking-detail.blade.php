    ...
    <div
        ...
        <div class="flex flex-col gap-4 pt-[22px]">
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold">
                    {{ $transaction->payment_method == 'down_payment' ? 'Down Payment 30%' : 'Full Payment 100%' }}</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
            ...
            <div class="flex items-center justify-between">
                ...
                <p class="font-semibold">Rp
                    {{ number_format($transaction->boardingHouse->price * $transaction->duration, 0, ',', '.') }}</p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">Rp
                    {{ number_format($transaction->boardingHouse->price * $transaction->duration * 0.11, 0, ',', '.') }}
                </p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">Rp
                    {{ number_format($transaction->boardingHouse->price * $transaction->duration * 0.01, 0, ',', '.') }}
                </p>
            </div>
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                ...
                <p class="font-semibold">Rp
                    {{ number_format($transaction->boardingHouse->price * $transaction->duration + $transaction->boardingHouse->price * $transaction->duration * 0.11 + $transaction->boardingHouse->price * $transaction->duration * 0.01, 0, ',', '.') }}
                </p>
            </div>
